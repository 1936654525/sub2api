...
func (s *SettingService) buildSystemSettingsUpdates(ctx context.Context, settings *SystemSettings) (map[string]string, error) {
	...
	updates[SettingKeyEnableGlobalSystemPrompt] = strconv.FormatBool(settings.EnableGlobalSystemPrompt)
	updates[SettingKeyGlobalSystemPrompt] = settings.GlobalSystemPrompt
